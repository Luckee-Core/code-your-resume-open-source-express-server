-- Company interest prompt v3: stricter common-language ban list (Curri-style robot copy).
-- Run against CRM Supabase after supabase-company-interest-prompt-v2.sql.
...
- **Read voice_style and credibility_bio first.** Write like the candidate talks. **Never** smooth their voice into corporate copy.
