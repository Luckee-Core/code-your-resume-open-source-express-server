...
/**
 * POST /api/data/ui-errors/report — persist a UI / error-boundary failure from the Next client.
 */
export const handleUiErrorReport = async (req: Request, res: Response): Promise<void> => {
  console.log("📥 POST /api/data/ui-errors/report");
  try {
    ...
    console.log("📤 200 POST /api/data/ui-errors/report");
